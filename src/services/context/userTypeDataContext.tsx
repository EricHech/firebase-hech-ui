...
type BaseUserTypeDataContext<T2 extends keyof SoilDatabase, T3 extends object = {}> = {
...
export const createUserTypeDataContext = <T2 extends keyof SoilDatabase, T3 extends object = {}>(
  dataType: T2,
  poke: boolean
) => {
